...
$post = new TimberPost();
$context['page'] = $post;
$context['hero_img'] = get_field('quote_banner_hero_image');
$context['contact_form_img'] = get_field('quote_form_bg');
...
Timber::render( 'page_templates/quote-template.twig', $context );
